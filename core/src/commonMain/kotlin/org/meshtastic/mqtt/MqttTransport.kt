 ...
 *
 * This is a published service-provider interface (SPI): transport modules implement it and
 * supply an instance through [MqttConfig.Builder.transportFactory]. Most consumers never touch
 * it directly — they pick a transport module and use [MqttClient].
 */
