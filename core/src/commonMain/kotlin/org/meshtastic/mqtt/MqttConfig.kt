...
public data class MqttConfig(
    ...
    val transportFactory: MqttTransportFactory? = null,
) {
    init {
    ...
    public class Builder {
         ...
         *
         * Supply one from a transport module — `TcpTransportFactory()` from
         * `org.meshtastic:mqtt-client-transport-tcp` or `WebSocketTransportFactory()` from
         * `org.meshtastic:mqtt-client-transport-ws`. Combine both with `+` to accept either
         * endpoint type. Required before [MqttClient.connect].
         */
        public var transportFactory: MqttTransportFactory? = null
