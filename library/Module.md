...
See the [library README](https://github.com/meshtastic/MQTTtastic-Client-KMP/blob/main/library/README.md)
for an end-to-end quickstart and the
[Architecture Decision Records](https://github.com/meshtastic/MQTTtastic-Client-KMP/tree/main/docs/adr)
